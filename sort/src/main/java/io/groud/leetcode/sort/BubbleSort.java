...
import static io.groud.leetcode.sort.Sorts.*;

/**
 * 冒泡排序
 * ———————————————————————————————————————————————————————————————————————————————
 * 总体思想：
 * 每次在 N 长度内找最大的元素放到 N 的位置，比较替换
 * ———————————————————————————————————————————————————————————————————————————————
 * 排序过程：
 ...
 * ———————————————————————————————————————————————————————————————————————————————
 * 针对有序数组优化点：
 * - 使用临时变量记录是否发生交换操作，如果没有发生说明已经是有序数组，直接退出排序
 * ———————————————————————————————————————————————————————————————————————————————
 * 复杂度：
...
public class BubbleSort implements Sort {
    ...
    public <T extends Comparable<T>> void sort(T[] array) {
        ...
        while (count < length) {
            ...
            boolean needSwap = false; // 如果不需要进行交换，说明本身已经有序
