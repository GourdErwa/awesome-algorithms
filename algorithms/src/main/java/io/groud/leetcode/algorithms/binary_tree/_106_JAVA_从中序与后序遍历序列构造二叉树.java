...
public class _106_JAVA_从中序与后序遍历序列构造二叉树 {
     ...
     * <p>
     * 1、根据 pRootIndex 从后序序列中找到根节点的值
     * 2、然后查询该值在中序序列的位置为 rootIndex
     * 3、由 rootIndex 将当前中序序列切分成左右子树：
     * 左子树中序序列起止位置为 [is, rootIndex - 1]，对应根节点在后序序列的位置为 pRootIndex - (ie - rootIndex) - 1
     * 右子树中序序列起止位置为 [rootIndex + 1, ie]，对应根节点在后序序列的位置为 pRootIndex - 1
     *
     * @param pRootIndex root 节点在后序序列的位置
     * @param is         中序序列起始位置
     * @param ie         中序序列结束位置
     * @return root 节点
     */
