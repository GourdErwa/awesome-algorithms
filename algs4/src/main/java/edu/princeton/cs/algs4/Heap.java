/******************************************************************************
 * Compilation: javac Heap.java Execution: java Heap < input.txt Dependencies: StdOut.java StdIn.java Data files:
 ...
 * comparisons take constant time). It makes at most 2 <em>n</em> log<sub>2</sub> <em>n</em> compares.
 * <p>
...
public class Heap {
    ...
    /**
     * Reads in a sequence of strings from standard input; heapsorts them; and prints them to standard output in
     * ascending order.
     *
     * @param args
