/******************************************************************************
 * Compilation: javac BinarySearchST.java Execution: java BinarySearchST Dependencies: StdIn.java StdOut.java Data
 ...
 * provides ordered methods for finding the <em>minimum</em>, <em>maximum</em>, <em>floor</em>, <em>select</em>, and
 ...
 * <p>
 * This implementation uses a <em>sorted array</em>. The <em>put</em> and <em>remove</em> operations take
 * &Theta;(<em>n</em>) time in the worst case. The <em>contains</em>, <em>ceiling</em>, <em>floor</em>, and
 * <em>rank</em> operations take &Theta;(log <em>n</em>) time in the worst case. The <em>size</em>, <em>is-empty</em>,
 * <em>minimum</em>, <em>maximum</em>, and <em>select</em> operations take &Theta;(1) time. Construction takes
 * &Theta;(1) time.
 * <p>
 * For alternative implementations of the symbol table API, see {@link ST}, {@link BST}, {@link SequentialSearchST},
 * {@link RedBlackBST}, {@link SeparateChainingHashST}, and {@link LinearProbingHashST}, For additional documentation,
 * see <a href="https://algs4.cs.princeton.edu/31elementary">Section 3.1</a> of <i>Algorithms, 4th Edition</i> by Robert
