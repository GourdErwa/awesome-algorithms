/******************************************************************************
 * Compilation: javac Quick3way.java Execution: java Quick3way < input.txt Dependencies: StdOut.java StdIn.java Data
 * files: https://algs4.cs.princeton.edu/23quicksort/tiny.txt https://algs4.cs.princeton.edu/23quicksort/words3.txt
 *
 ...
 *
 * % java Quick3way < words3.txt all bad bed bug dad ... yes yet zoo [ one string per line ]
 *
 ******************************************************************************/
...
/**
 * The {@code Quick3way} class provides static methods for sorting an array using quicksort with 3-way partitioning.
 * <p>
...
public class Quick3way {
    ...
    /**
     * Reads in a sequence of strings from standard input; 3-way quicksorts them; and prints them to standard output in
     * ascending order.
     *
     * @param args
