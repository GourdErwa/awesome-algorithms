/******************************************************************************
 * Compilation: javac RedBlackBST.java Execution: java RedBlackBST < input.txt Dependencies: StdIn.java StdOut.java Data
 ...
 * method to compare two keys. It does not call either {@code equals()} or {@code hashCode()}.
 * <p>
 * This implementation uses a <em>left-leaning red-black BST</em>. The <em>put</em>, <em>get</em>, <em>contains</em>,
 * <em>remove</em>, <em>minimum</em>, <em>maximum</em>, <em>ceiling</em>, <em>floor</em>, <em>rank</em>, and
 * <em>select</em> operations each take &Theta;(log <em>n</em>) time in the worst case, where <em>n</em> is the number
 * of key-value pairs in the symbol table. The <em>size</em>, and <em>is-empty</em> operations take &Theta;(1) time. The
 * <em>keys</em> methods take <em>O</em>(log <em>n</em> + <em>m</em>) time, where <em>m</em> is the number of keys
 * returned by the iterator. Construction takes &Theta;(1) time.
 * <p>
 * For alternative implementations of the symbol table API, see {@link ST}, {@link BinarySearchST},
 * {@link SequentialSearchST}, {@link BST}, {@link SeparateChainingHashST}, {@link LinearProbingHashST}, and
 * {@link AVLTreeST}. For additional documentation, see <a href="https://algs4.cs.princeton.edu/33balanced">Section
...
public class RedBlackBST<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Return the key in the symbol table of a given {@code rank}. This key has the property that there are {@code rank}
     * keys in the symbol table that are smaller. In other words, this key is the ({@code rank}+1)st smallest key in the
     * symbol table.
     *
     * @param rank
     *        the order statistic
     ...
     * @param hi
     *        maximum endpoint
     * @return all keys in the symbol table between {@code lo} (inclusive) and {@code hi} (inclusive) as an
     *         {@code Iterable}
     * @throws IllegalArgumentException
