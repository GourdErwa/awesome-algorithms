 ...
 * https://algs4.cs.princeton.edu/11model/tinyT.txt https://algs4.cs.princeton.edu/11model/largeW.txt
 * https://algs4.cs.princeton.edu/11model/largeT.txt
 *
 * % java BinarySearch tinyW.txt < tinyT.txt 50 99 13
 *
 * % java BinarySearch largeW.txt < largeT.txt | more 499569 984875 295754 207807 140925 161828 [367,966 total values]
 *
 ******************************************************************************/
...
/**
 * The {@code BinarySearch} class provides a static method for binary searching for an integer in a sorted array of
 * integers.
 * <p>
...
public class BinarySearch {
    ...
    /**
     * Returns the index of the specified key in the specified array. This function is poorly named because it does not
