/******************************************************************************
 * Compilation: javac LSD.java Execution: java LSD < input.txt Dependencies: StdIn.java StdOut.java Data files:
 ...
 *
 * - Sort an int[] array of n 32-bit integers, treating each integer as a sequence of w = 4 bytes (R = 256).
 *
...
/**
 * The {@code LSD} class provides static methods for sorting an array of <em>w</em>-character strings or 32-bit integers
...
public class LSD {
    ...
    /**
     * Reads in a sequence of fixed-length strings from standard input; LSD radix sorts them; and prints them to
