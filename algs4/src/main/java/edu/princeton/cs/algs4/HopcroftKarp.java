/******************************************************************************
 * Compilation: javac HopcroftKarp.java Execution: java HopcroftKarp V1 V2 E Dependencies: FordFulkerson.java
 * FlowNetwork.java FlowEdge.java BipartiteX.java
 *
 * Find a maximum cardinality matching (and minimum cardinality vertex cover) in a bipartite graph using Hopcroft-Karp
 * algorithm.
 *
 ******************************************************************************/
...
/**
 * The {@code HopcroftKarp} class represents a data type for computing a <em>maximum (cardinality) matching</em> and a
 * <em>minimum (cardinality) vertex cover</em> in a bipartite graph. A <em>bipartite graph</em> in a graph whose
 ...
 * <p>
 * This implementation uses the <em>Hopcroft-Karp algorithm</em>. The order of growth of the running time in the worst
 * case is (<em>E</em> + <em>V</em>) sqrt(<em>V</em>), where <em>E</em> is the number of edges and <em>V</em> is the
 * number of vertices in the graph. It uses extra space (not including the graph) proportional to <em>V</em>.
 * <p>
 * See also {@link BipartiteMatching}, which solves the problem in O(<em>E V</em>) time using the <em>alternating path
 * algorithm</em> and <a href =
