/******************************************************************************
 * Compilation: javac LongestCommonSubstring.java Execution: java LongestCommonSubstring file1.txt file2.txt
 * Dependencies: SuffixArray.java In.java StdOut.java Data files: https://algs4.cs.princeton.edu/63suffix/tale.txt
 * https://algs4.cs.princeton.edu/63suffix/mobydick.txt
 *
 * Read in two text files and find the longest substring that appears in both texts.
 *
 * % java LongestCommonSubstring tale.txt mobydick.txt ' seemed on the point of being '
 *
 ******************************************************************************/
...
/**
 * The {@code LongestCommonSubstring} class provides a {@link SuffixArray} client for computing the longest common
 * substring that appears in two given strings.
 * <p>
 * This implementation computes the suffix array of each string and applies a merging operation to determine the longest
 * common substring. For an alternate implementation, see <a href =
...
public class LongestCommonSubstring {
    ...
    /**
     * Unit tests the {@code lcs()} method. Reads in two strings from files specified as command-line arguments;
