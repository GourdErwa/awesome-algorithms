/******************************************************************************
 * Compilation: javac Edge.java Execution: java Edge Dependencies: StdOut.java
 *
...
/**
 * The {@code Edge} class represents a weighted edge in an {@link EdgeWeightedGraph}. Each edge consists of two integers
...
public class Edge implements Comparable<Edge> {
    ...
    /**
     * Compares two edges by weight. Note that {@code compareTo()} is not consistent with {@code equals()}, which uses
