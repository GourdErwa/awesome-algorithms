/******************************************************************************
 * Compilation: javac DirectedDFS.java Execution: java DirectedDFS digraph.txt s Dependencies: Digraph.java Bag.java
 ...
 *
 * Determine single-source or multiple-source reachability in a digraph using depth first search. Runs in O(E + V) time.
 *
 * % java DirectedDFS tinyDG.txt 1 1
 *
 * % java DirectedDFS tinyDG.txt 2 0 1 2 3 4 5
 *
 * % java DirectedDFS tinyDG.txt 1 2 6 0 1 2 3 4 5 6 8 9 10 11 12
 *
 ******************************************************************************/
...
/**
 * The {@code DirectedDFS} class represents a data type for determining the vertices reachable from a given source
 * vertex <em>s</em> (or set of source vertices) in a digraph. For versions that find the paths, see
 * {@link DepthFirstDirectedPaths} and {@link BreadthFirstDirectedPaths}.
 * <p>
 * This implementation uses depth-first search. The constructor takes time proportional to <em>V</em> + <em>E</em> (in
 * the worst case), where <em>V</em> is the number of vertices and <em>E</em> is the number of edges. Each instance
 * method takes &Theta;(1) time. It uses &Theta;(<em>V</em>) extra space (not including the digraph).
 * <p>
