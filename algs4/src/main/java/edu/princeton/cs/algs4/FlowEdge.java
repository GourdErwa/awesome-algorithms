/******************************************************************************
 * Compilation: javac FlowEdge.java Execution: java FlowEdge Dependencies: StdOut.java
 *
...
/**
 * The {@code FlowEdge} class represents a capacitated edge with a flow in a {@link FlowNetwork}. Each edge consists of
 * two integers (naming the two vertices), a real-valued capacity, and a real-valued flow. The data type provides
 * methods for accessing the two endpoints of the directed edge and the weight. It also provides methods for changing
 * the amount of flow on the edge and determining the residual capacity of the edge.
 * <p>
...
public class FlowEdge {
    ...
    /**
     * Returns the endpoint of the edge that is different from the given vertex (unless the edge represents a self-loop
    ...
    /**
     * Increases the flow on the edge in the direction to the given vertex. If {@code vertex} is the tail vertex, this
     * increases the flow on the edge by {@code delta}; if {@code vertex} is the head vertex, this decreases the flow on
