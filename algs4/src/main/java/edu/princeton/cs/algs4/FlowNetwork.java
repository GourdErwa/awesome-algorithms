/******************************************************************************
 * Compilation: javac FlowNetwork.java Execution: java FlowNetwork V E Dependencies: Bag.java FlowEdge.java
 *
...
/**
 * The {@code FlowNetwork} class represents a capacitated network with vertices named 0 through <em>V</em> - 1, where
 * each directed edge is of type {@link FlowEdge} and has a real-valued capacity and flow. It supports the following two
 * primary operations: add an edge to the network, iterate over all of the edges incident to or from a vertex. It also
 * provides methods for returning the number of vertices <em>V</em> and the number of edges <em>E</em>. Parallel edges
 ...
 * All operations take constant time (in the worst case) except iterating over the edges incident to a given vertex,
...
public class FlowNetwork {
    ...
    /**
     * Initializes a random flow network with {@code V} vertices and <em>E</em> edges. The capacities are integers
    ...
    /**
     * Initializes a flow network from an input stream. The format is the number of vertices <em>V</em>, followed by the
     * number of edges <em>E</em>, followed by <em>E</em> pairs of vertices and edge capacities, with each entry
    ...
    /**
     * Returns a string representation of the flow network. This method takes time proportional to <em>E</em> +
     * <em>V</em>.
     *
