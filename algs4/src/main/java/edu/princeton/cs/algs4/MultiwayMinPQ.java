/******************************************************************************
 * Compilation: javac MultiwayMinPQ.java Execution:
 *
 * A multiway heap.
 *
 ******************************************************************************/
...
/**
 * The MultiwayMinPQ class represents a priority queue of generic keys. It supports the usual insert and
 * delete-the-minimum operations. It also supports methods for peeking at the minimum key, testing if the priority queue
 * is empty, and iterating through the keys. It is possible to build the priority queue using a Comparator. If not, the
 * natural order relation between the keys will be used.
 * <p>
 * This implementation uses a multiway heap. For simplified notations, logarithm in base d will be referred as log-d The
 * delete-the-minimum operation takes time proportional to d*log-d(n) The insert takes time proportional to log-d(n) The
 * is-empty, min-key and size operations take constant time. Constructor takes time proportional to the specified
 * capacity.
 *
