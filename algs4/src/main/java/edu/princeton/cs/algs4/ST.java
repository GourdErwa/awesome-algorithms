/******************************************************************************
 * Compilation: javac ST.java Execution: java ST < input.txt Dependencies: StdIn.java StdOut.java Data files:
...
/**
 * The {@code ST} class represents an ordered symbol table of generic key-value pairs. It supports the usual
 ...
 * <p>
 * This implementation uses a <em>red-black BST</em>. The <em>put</em>, <em>get</em>, <em>contains</em>,
 * <em>remove</em>, <em>minimum</em>, <em>maximum</em>, <em>ceiling</em>, and <em>floor</em> operations each take
 * &Theta;(log <em>n</em>) time in the worst case, where <em>n</em> is the number of key-value pairs in the symbol
 * table. The <em>size</em> and <em>is-empty</em> operations take &Theta;(1) time. Construction takes &Theta;(1) time.
 * <p>
...
public class ST<Key extends Comparable<Key>, Value> implements Iterable<Key> {
     ...
     * <p>
     * To iterate over all of the keys in the symbol table named {@code st}, use the foreach notation:
    ...
    /**
     * Returns all of the keys in this symbol table. To iterate over all of the keys in a symbol table named {@code st},
     * use the foreach notation: {@code for (Key key : st)}.
     * <p>
     * This method is provided for backward compatibility with the version from <em>Introduction to Programming in Java:
     * An Interdisciplinary Approach.</em>
     *
