/******************************************************************************
 * Compilation: javac Draw.java Execution: java Draw Dependencies: none
 *
 * Drawing library. This class provides a basic capability for creating drawings with your programs. It uses a simple
 * graphics model that allows you to create drawings consisting of points, lines, and curves in a window on your
 * computer and to save the drawings to a file. This is the object-oriented version of standard draw; it supports
 * multiple indepedent drawing windows.
 *
 * Todo ---- - Add support for gradient fill, etc.
 *
 * Remarks ------- - don't use AffineTransform for rescaling since it inverts images and strings - careful using setFont
 * in inner loop within an animation - it can cause flicker
 *
 ******************************************************************************/
...
/**
 * <i>Draw</i>. This class provides a basic capability for creating drawings with your programs. It uses a simple
 * graphics model that allows you to create drawings consisting of points, lines, and curves in a window on your
 * computer and to save the drawings to a file. This is the object-oriented version of standard draw; it supports
 * multiple indepedent drawing windows.
 * <p>
...
public final class Draw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    /**
     * Shade of blue used in Introduction to Programming in Java. It is Pantone 300U. The RGB values are approximately
     * (9, 90, 166).
     */
    public static final Color BOOK_BLUE = new Color(9, 90, 166);

    /**
     * Shade of light blue used in Introduction to Programming in Java. The RGB values are approximately (103, 198,
     * 243).
     */
     ...
     *
     * @param value
     *            the value, typically {@code JFrame.EXIT_ON_CLOSE} (close all windows) or
     *            {@code JFrame.DISPOSE_ON_CLOSE} (close current window)
     */
    ...
    /**
     * Enable double buffering. All subsequent calls to drawing methods such as {@code line()}, {@code circle()}, and
    ...
    /**
     * Disable double buffering. All subsequent calls to drawing methods such as {@code line()}, {@code circle()}, and
     ...
     * <p>
     * This method takes as an argument the keycode (corresponding to a physical key). It can handle action keys (such
