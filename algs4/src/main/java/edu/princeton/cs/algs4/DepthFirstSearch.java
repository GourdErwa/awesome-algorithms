/******************************************************************************
 * Compilation: javac DepthFirstSearch.java Execution: java DepthFirstSearch filename.txt s Dependencies: Graph.java
...
/**
 * The {@code DepthFirstSearch} class represents a data type for determining the vertices connected to a given source
 * vertex <em>s</em> in an undirected graph. For versions that find the paths, see {@link DepthFirstPaths} and
 * {@link BreadthFirstPaths}.
 * <p>
 * This implementation uses depth-first search. See {@link NonrecursiveDFS} for a non-recursive version. The constructor
 * takes &Theta;(<em>V</em> + <em>E</em>) time in the worst case, where <em>V</em> is the number of vertices and
 * <em>E</em> is the number of edges. Each instance method takes &Theta;(1) time. It uses &Theta;(<em>V</em>) extra
