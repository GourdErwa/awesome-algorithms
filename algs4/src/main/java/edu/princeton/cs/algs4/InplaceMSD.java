/******************************************************************************
 * Compilation: javac InplaceMSD.java Execution: java InplaceMSD < input.txt Dependencies: StdIn.java StdOut.java Data
 * files: https://algs4.cs.princeton.edu/51radix/words3.txt https://algs4.cs.princeton.edu/51radix/shells.txt
 *
 * Sort an array of strings or integers using in-place MSD radix sort.
 *
 * % java InplaceMSD < shells.txt are by sea seashells seashells sells sells she she shells shore surely the the
 *
 ******************************************************************************/
...
/**
 * The {@code InplaceMSD} class provides static methods for sorting an array of extended ASCII strings using in-place
 * MSD radix sort.
 * <p>
...
public class InplaceMSD {
    ...
    /**
     * Reads in a sequence of extended ASCII strings from standard input; in-place MSD radix sorts them; and prints them
