/******************************************************************************
 * Compilation: javac DepthFirstPaths.java Execution: java DepthFirstPaths G s Dependencies: Graph.java Stack.java
...
/**
 * The {@code DepthFirstPaths} class represents a data type for finding paths from a source vertex <em>s</em> to every
 * other vertex in an undirected graph.
 * <p>
...
public class DepthFirstPaths {
     ...
     * @param v
     *            the vertex
     * @return the sequence of vertices on a path between the source vertex {@code s} and vertex {@code v}, as an
     *         Iterable
     * @throws IllegalArgumentException
     *             unless {@code 0 <= v < V}
     */
