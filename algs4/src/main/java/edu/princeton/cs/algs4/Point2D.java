/******************************************************************************
 * Compilation: javac Point2D.java Execution: java Point2D x0 y0 n Dependencies: StdDraw.java StdRandom.java
 *
 ...
 * <p>
 * Note: in order to deal with the difference behavior of double and Double with respect to -0.0 and +0.0, the Point2D
 * constructor converts any coordinates that are -0.0 to +0.0.
 * <p>
...
public final class Point2D implements Comparable<Point2D> {
     ...
     * than the argument point (x1, y1) if and only if either {@code y0 < y1} or if {@code y0 == y1} and
     * {@code x0 < x1}.
     *
     * @param that
     *            the other point
