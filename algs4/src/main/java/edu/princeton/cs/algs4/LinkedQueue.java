/******************************************************************************
 * Compilation: javac LinkedQueue.java Execution: java LinkedQueue < input.txt Dependencies: StdIn.java StdOut.java Data
 * files: https://algs4.cs.princeton.edu/13stacks/tobe.txt
 *
...
/**
 * The {@code LinkedQueue} class represents a first-in-first-out (FIFO) queue of generic items. It supports the usual
 ...
 * <p>
 * This implementation uses a singly linked list with a non-static nested class for linked-list nodes. See {@link Queue}
 * for a version that uses a static nested class. The <em>enqueue</em>, <em>dequeue</em>, <em>peek</em>, <em>size</em>,
