/******************************************************************************
 * Compilation: javac ClosestPair.java Execution: java ClosestPair < input.txt Dependencies: Point2D.java Data files:
...
/**
 * The {@code ClosestPair} data type computes a closest pair of points in a set of <em>n</em> points in the plane and
 * provides accessor methods for getting the closest pair of points and the distance between them. The distance between
 * two points is their Euclidean distance.
 * <p>
 * This implementation uses a divide-and-conquer algorithm. It runs in O(<em>n</em> log <em>n</em>) time in the worst
 * case and uses O(<em>n</em>) extra space.
 * <p>
...
public class ClosestPair {
     ...
     *
     * @return one of the two points in the closest pair of points; {@code null} if no such point (because there are
     *         fewer than 2 points)
     */
     ...
     *
     * @return the other point in the closest pair of points {@code null} if no such point (because there are fewer than
     *         2 points)
     */
     ...
     *
     * @return the Euclidean distance between the closest pair of points {@code Double.POSITIVE_INFINITY} if no such
    ...
    /**
     * Unit tests the {@code ClosestPair} data type. Reads in an integer {@code n} and {@code n} points (specified by
     * their <em>x</em>- and <em>y</em>-coordinates) from standard input; computes a closest pair of points; and prints
