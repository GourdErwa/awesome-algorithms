/******************************************************************************
 * Compilation: javac AmericanFlagX.java Execution: java AmericanFlagX < input.txt Dependencies: StdIn.java StdOut.java
 ...
 *
 * % java AmericanFlagX < shells.txt are by sea seashells seashells sells sells she she shells shore surely the the
 *
 ******************************************************************************/
...
/**
 * The {@code AmericanFlagX} class provides static methods for sorting an array of extended ASCII strings or integers
 * in-place using American Flag sort. This implementation is non-recursive and uses only one auxiliary array.
 * <p>
 ...
 * McIlroy and Bostic. For a version that uses two auxilary arrays, see {@link AmericanFlag}.
 *
 * @author Ivan Pesin
 */
...
public class AmericanFlagX {
    ...
    /**
     * Rearranges the array of extended ASCII strings in ascending order. This is an unstable in-place sorting
     * algorithm.
     *
     * @param a
