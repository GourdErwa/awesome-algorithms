/******************************************************************************
 * Compilation: javac SparseVector.java Execution: java SparseVector Dependencies: StdOut.java
 *
...
/**
 * The {@code SparseVector} class represents a <em>d</em>-dimensional mathematical vector. Vectors are mutable: their
 * values can be changed after they are created. It includes methods for addition, subtraction, dot product, scalar
 ...
 * it efficient when most of the vector coordindates are zero.
 * <p>
 * For additional documentation, see <a href="https://algs4.cs.princeton.edu/35applications">Section 3.5</a> of
 * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne. See also {@link Vector} for an immutable (dense)
 * vector data type.
 *
...
public class SparseVector {
     ...
     *
     * @return a string representation of this vector, which consists of the the vector entries, separates by commas,
