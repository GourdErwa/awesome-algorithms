/******************************************************************************
 * Compilation: javac DrawListener.java Execution: none Dependencies: none
 *
...
/**
 * <i>DrawListener</i>. This interface provides a basic capability for responding to keyboard in mouse events from
 * {@link Draw} via callbacks. You can see some examples in
