/******************************************************************************
 * Compilation: javac AssignmentProblem.java Execution: java AssignmentProblem n Dependencies: DijkstraSP.java
 * DirectedEdge.java
 *
 * Solve an n-by-n assignment problem in n^3 log n time using the successive shortest path algorithm.
 *
 ******************************************************************************/
...
/**
 * The {@code AssignmentProblem} class represents a data type for computing an optimal solution to an
 * <em>n</em>-by-<em>n</em> <em>assignment problem</em>. The assignment problem is to find a minimum weight matching in
 * an edge-weighted complete bipartite graph.
 * <p>
 * The data type supplies methods for determining the optimal solution and the corresponding dual solution.
 * <p>
 * This implementation uses the <em>successive shortest paths algorithm</em>. The order of growth of the running time in
 * the worst case is O(<em>n</em>^3 log <em>n</em>) to solve an <em>n</em>-by-<em>n</em> instance.
 * <p>
...
public class AssignmentProblem {
    ...
    /**
     * Unit tests the {@code AssignmentProblem} data type. Takes a command-line argument n; creates a random n-by-n
