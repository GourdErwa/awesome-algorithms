/******************************************************************************
 * Compilation: javac SET.java Execution: java SET Dependencies: StdOut.java
 *
 ...
 * <em>equality</em>.
 * <p>
 * Even though this implementation include the method {@code equals()}, it does not support the method
 * {@code hashCode()} because sets are mutable.
 * <p>
 ...
 * either {@code equals()} or {@code hashCode()}. The <em>add</em>, <em>contains</em>, <em>delete</em>,
 * <em>minimum</em>, <em>maximum</em>, <em>ceiling</em>, and <em>floor</em> methods take logarithmic time in the worst
 * case. The <em>size</em>, and <em>is-empty</em> operations take constant time. Construction takes constant time.
 * <p>
...
public class SET<Key extends Comparable<Key>> implements Iterable<Key> {
    ...
    /**
     * Removes the specified key from this set (if the set contains the specified key). This is equivalent to
