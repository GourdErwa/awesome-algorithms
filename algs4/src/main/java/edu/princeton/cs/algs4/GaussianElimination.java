/******************************************************************************
 * Compilation: javac GaussianElimination.java Execution: java GaussianElimination m n Dependencies: StdOut.java
 *
 * Gaussian elimination with partial pivoting for m-by-n system.
 *
 * % java GaussianElimination m n -1.000000 2.000000 2.000000
 *
...
/**
 * The {@code GaussianElimination} data type provides methods to solve a linear system of equations <em>Ax</em> =
 * <em>b</em>, where <em>A</em> is an <em>m</em>-by-<em>n</em> matrix and <em>b</em> is a length <em>n</em> vector.
 * <p>
 * This is a bare-bones implementation that uses Gaussian elimination with partial pivoting. See <a href =
 * "https://algs4.cs.princeton.edu/99scientific/GaussianEliminationLite.java.html">GaussianEliminationLite.java</a> for
 * a stripped-down version that assumes the matrix <em>A</em> is square and nonsingular. See
 * {@link GaussJordanElimination} for an alternate implementation that uses Gauss-Jordan elimination. For an
...
public class GaussianElimination {
    ...
    /**
     * Solves the linear system of equations <em>Ax</em> = <em>b</em>, where <em>A</em> is an <em>m</em>-by-<em>n</em>
