/******************************************************************************
 * Compilation: javac Stack.java Execution: java Stack < input.txt Dependencies: StdIn.java StdOut.java Data files:
...
/**
 * The {@code Stack} class represents a last-in-first-out (LIFO) stack of generic items. It supports the usual
 ...
 * {@link LinkedStack} for the version from the textbook that uses a non-static nested class. See
 * {@link ResizingArrayStack} for a version that uses a resizing array. The <em>push</em>, <em>pop</em>, <em>peek</em>,
 * <em>size</em>, and <em>is-empty</em> operations all take constant time in the worst case.
 * <p>
