/******************************************************************************
 * Compilation: javac RectHV.java Execution: none Dependencies: Point2D.java
 *
...
/**
 * The {@code RectHV} class is an immutable data type to encapsulate a two-dimensional axis-aligned rectagle with
 * real-value coordinates. The rectangle is <em>closed</em>—it includes the points on the boundary.
 * <p>
...
public final class RectHV {
     ...
     *
     * @return a string representation of this rectangle, using the format {@code [xmin, xmax] x [ymin, ymax]}
     */
    @Override
