/******************************************************************************
 * Compilation: javac MergeBU.java Execution: java MergeBU < input.txt Dependencies: StdOut.java StdIn.java Data files:
 ...
 *
 * % java MergeBU < tiny.txt A E E L M O P R S T X [ one string per line ]
 *
 * % more words3.txt bed bug dad yes zoo ... all bad yet
 *
 * % java MergeBU < words3.txt all bad bed bug dad ... yes yet zoo [ one string per line ]
 *
 ******************************************************************************/
...
/**
 * The {@code MergeBU} class provides static methods for sorting an array using <em>bottom-up mergesort</em>. It is
 * non-recursive.
 * <p>
...
public class MergeBU {
    ...
    /**
     * Reads in a sequence of strings from standard input; bottom-up mergesorts them; and prints them to standard output
     * in ascending order.
     *
     * @param args
