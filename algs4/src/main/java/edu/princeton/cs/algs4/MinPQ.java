/******************************************************************************
 * Compilation: javac MinPQ.java Execution: java MinPQ < input.txt Dependencies: StdIn.java StdOut.java Data files:
 * https://algs4.cs.princeton.edu/24pq/tinyPQ.txt
 *
 * Generic min priority queue implementation with a binary heap. Can be used with a comparator instead of the natural
 * order.
 *
 ...
 * <p>
 * This implementation uses a <em>binary heap</em>. The <em>insert</em> and <em>delete-the-minimum</em> operations take
