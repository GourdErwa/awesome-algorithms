/******************************************************************************
 * Compilation: javac MSD.java Execution: java MSD < input.txt Dependencies: StdIn.java StdOut.java Data files:
 ...
 *
 * % java MSD < shells.txt are by sea seashells seashells sells sells she she shells shore surely the the
 *
 ******************************************************************************/
...
/**
 * The {@code MSD} class provides static methods for sorting an array of extended ASCII strings or integers using MSD
 * radix sort.
 * <p>
...
public class MSD {
    ...
    private static void sort(int[] a, int lo, int hi, int d, int[] aux) {
        ...
        /*************
         * BUGGGY CODE. // for most significant byte, 0x80-0xFF comes before 0x00-0x7F if (d == 0) { int shift1 =
         * count[R] - count[R/2]; int shift2 = count[R/2]; for (int r = 0; r < R/2; r++) count[r] += shift1; for (int r
         * = R/2; r < R; r++) count[r] -= shift2; }
         ************************************/
        // distribute
        for (int i = lo; i <= hi; i++) {
            int c = (a[i] >> shift) & mask;
    ...
    /**
     * Reads in a sequence of extended ASCII strings from standard input; MSD radix sorts them; and prints them to
