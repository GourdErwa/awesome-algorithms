/******************************************************************************
 * Compilation: javac Complex.java Execution: java Complex Dependencies: StdOut.java
 *
...
/**
 * The {@code Complex} class represents a complex number. Complex numbers are immutable: their values cannot be changed
 * after they are created. It includes methods for addition, subtraction, multiplication, division, conjugation, and
...
public class Complex {
    ...
    /**
     * Returns the absolute value of this complex number. This quantity is also known as the <em>modulus</em> or
     * <em>magnitude</em>.
     *
    ...
    /**
     * Returns the phase of this complex number. This quantity is also known as the <em>angle</em> or <em>argument</em>.
     *
