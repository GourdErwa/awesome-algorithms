/******************************************************************************
 * Compilation: javac GrahamaScan.java Execution: java GrahamScan < input.txt Dependencies: Point2D.java Data files:
 ...
 *
 * % java GrahamScan < input100.txt (7486.0, 422.0) (29413.0, 596.0) (32011.0, 3140.0) (30875.0, 28560.0) (28462.0,
 * 32343.0) (15731.0, 32661.0) (822.0, 32301.0) (823.0, 15895.0) (1444.0, 10362.0) (4718.0, 4451.0)
 *
 ******************************************************************************/
...
/**
 * The {@code GrahamScan} data type provides methods for computing the convex hull of a set of <em>n</em> points in the
 * plane.
 * <p>
 * The implementation uses the Graham-Scan convex hull algorithm. It runs in O(<em>n</em> log <em>n</em>) time in the
 * worst case and uses O(<em>n</em>) extra memory.
 * <p>
...
public class GrahamScan {
    ...
    /**
     * Unit tests the {@code GrahamScan} data type. Reads in an integer {@code n} and {@code n} points (specified by
     * their <em>x</em>- and <em>y</em>-coordinates) from standard input; computes their convex hull; and prints out the
