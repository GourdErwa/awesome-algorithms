/******************************************************************************
 * Compilation: javac LinkedStack.java Execution: java LinkedStack < input.txt Dependencies: StdIn.java StdOut.java Data
 ...
 *
 * % java LinkedStack < tobe.txt to be not that or be (2 left on stack)
 *
 ******************************************************************************/
...
/**
 * The {@code LinkedStack} class represents a last-in-first-out (LIFO) stack of generic items. It supports the usual
 ...
 * <p>
 * This implementation uses a singly linked list with a non-static nested class for linked-list nodes. See {@link Stack}
 * for a version that uses a static nested class. The <em>push</em>, <em>pop</em>, <em>peek</em>, <em>size</em>, and
