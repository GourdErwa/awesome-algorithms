/******************************************************************************
 * Compilation: javac HexDump.java Execution: java HexDump < file Dependencies: BinaryStdIn.java StdOut.java Data file:
 ...
 *
 *
 * Remark -------------------------- - Similar to the Unix utilities od (octal dump) or hexdump (hexadecimal dump).
 *
...
/**
 * The {@code HexDump} class provides a client for displaying the contents of a binary file in hexadecimal.
 * <p>
 * For additional documentation, see <a href="https://algs4.cs.princeton.edu/55compression">Section 5.5</a> of
 * <i>Algorithms, 4th Edition</i> by Robert Sedgewick and Kevin Wayne.
 * <p>
 * See also {@link BinaryDump} and {@link PictureDump}. For more full-featured versions, see the Unix utilities
...
public class HexDump {
    ...
    /**
     * Reads in a sequence of bytes from standard input and writes them to standard output using hexademical notation, k
     * hex digits per line, where k is given as a command-line integer (defaults to 16 if no integer is specified); also
