/******************************************************************************
 * Compilation: javac RandomSeq.java Execution: java RandomSeq n lo hi Dependencies: StdOut.java
 *
...
/**
 * The {@code RandomSeq} class is a client that prints out a pseudorandom sequence of real numbers in a given range.
 * <p>
...
public class RandomSeq {
    ...
    /**
     * Reads in two command-line arguments lo and hi and prints n uniformly random real numbers in [lo, hi) to standard
     * output.
     *
     * @param args
