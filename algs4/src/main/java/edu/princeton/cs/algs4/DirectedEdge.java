/******************************************************************************
 * Compilation: javac DirectedEdge.java Execution: java DirectedEdge Dependencies: StdOut.java
 *
 ...
 * two integers (naming the two vertices) and a real-value weight. The data type provides methods for accessing the two
 * endpoints of the directed edge and the weight.
 * <p>
