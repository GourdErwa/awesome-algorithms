 ...
 *
 * % java Polynomial zero(x) = 0 p(x) = 4x^3 + 3x^2 + 2x + 1 q(x) = 3x^2 + 5 p(x) + q(x) = 4x^3 + 6x^2 + 2x + 6 p(x) *
 * q(x) = 12x^5 + 9x^4 + 26x^3 + 18x^2 + 10x + 5 p(q(x)) = 108x^6 + 567x^4 + 996x^2 + 586 p(x) - p(x) = 0 0 - p(x) =
 * -4x^3 - 3x^2 - 2x - 1 p(3) = 142 p'(x) = 12x^2 + 6x + 2 p''(x) = 24x + 6
 *
 ******************************************************************************/
...
/**
 * The {@code Polynomial} class represents a polynomial with integer coefficients. Polynomials are immutable: their
 * values cannot be changed after they are created. It includes methods for addition, subtraction, multiplication,
 * composition, differentiation, and evaluation.
 * <p>
...
public class Polynomial {
    ...
    /**
     * Returns the product of this polynomial and the specified polynomial. Takes time proportional to the product of
    ...
    /**
     * Returns the composition of this polynomial and the specified polynomial. Takes time proportional to the product
