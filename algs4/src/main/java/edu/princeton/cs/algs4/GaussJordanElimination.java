/******************************************************************************
 * Compilation: javac GaussJordanElimination.java Execution: java GaussJordanElimination n Dependencies: StdOut.java
 *
 * Finds a solutions to Ax = b using Gauss-Jordan elimination with partial pivoting. If no solution exists, find a
 * solution to yA = 0, yb != 0, which serves as a certificate of infeasibility.
 *
 * % java GaussJordanElimination -1.000000 2.000000 2.000000
 *
 * 3.000000 -1.000000 -2.000000
 *
 * System is infeasible
 *
 * -6.250000 -4.500000 0.000000 0.000000 1.000000
 *
 * System is infeasible
 *
 * -1.375000 1.625000 0.000000
 *
 *
 ******************************************************************************/
...
/**
 * The {@code GaussJordanElimination} data type provides methods to solve a linear system of equations <em>Ax</em> =
 * <em>b</em>, where <em>A</em> is an <em>n</em>-by-<em>n</em> matrix and <em>b</em> is a length <em>n</em> vector. If
 * no solution exists, it finds a solution <em>y</em> to <em>yA</em> = 0, <em>yb</em> &ne; 0, which which serves as a
 * certificate of infeasibility.
 * <p>
 * This implementation uses Gauss-Jordan elimination with partial pivoting. See {@link GaussianElimination} for an
 * implementation that uses Gaussian elimination (but does not provide the certificate of infeasibility). For an
 * industrial-strength numerical linear algebra library, see
 * <a href = "http://math.nist.gov/javanumerics/jama/">JAMA</a>.
 * <p>
 * For additional documentation, see <a href="https://algs4.cs.princeton.edu/99scientific">Section 9.9</a>
...
public class GaussJordanElimination {
    ...
    /**
     * Solves the linear system of equations <em>Ax</em> = <em>b</em>, where <em>A</em> is an <em>n</em>-by-<em>n</em>
     ...
     *
     * @return a solution <em>x</em> to the linear system of equations <em>Ax</em> = <em>b</em>; {@code null} if no such
     *         solution
     */
     ...
     *
     * @return a solution <em>y</em> to the linear system of equations <em>yA</em> = 0, <em>yb</em> &ne; 0; {@code null}
     *         if no such solution
     */
    public double[] dual() {
     ...
     *
     * @return {@code true} if there exists a solution to the linear system of equations <em>Ax</em> = <em>b</em>;
