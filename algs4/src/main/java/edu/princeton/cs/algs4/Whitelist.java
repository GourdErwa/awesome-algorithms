/******************************************************************************
 * Compilation: javac Whitelist.java Execution: java Whitelist whitelist.txt < data.txt Dependencies:
 * StaticSetOfInts.java In.java StdOut.java
 *
 * Data files: https://algs4.cs.princeton.edu/11model/tinyW.txt https://algs4.cs.princeton.edu/11model/tinyT.txt
 * https://algs4.cs.princeton.edu/11model/largeW.txt https://algs4.cs.princeton.edu/11model/largeT.txt
 *
 * Whitelist filter.
 *
 *
 ...
 *
 * % java Whitelist largeW.txt < largeT.txt | more 499569 984875 295754 207807 140925 161828 [367,966 total values]
 *
 ******************************************************************************/
...
/**
 * The {@code Whitelist} class provides a client for reading in a set of integers from a file; reading in a sequence of
 * integers from standard input; and printing to standard output those integers not in the whitelist.
 * <p>
