 ...
 *
 * Read in a whitelist of words from a file. Then read in a list of words from standard input and print out all those
 * words that are in the first file.
 *
 ...
 *
 * % java WhiteFilter list.txt < tinyTale.txt it was the of it was the of it was the of it was the of it was the of it
...
/**
 * The {@code WhiteFilter} class provides a client for reading in a <em>whitelist</em> of words from a file; then,
 * reading in a sequence of words from standard input, printing out each word that appears in the file. It is useful as
