/******************************************************************************
 * Compilation: javac Bipartite.java Execution: java Bipartite V E F Dependencies: Graph.java Data files:
...
/**
 * The {@code Bipartite} class represents a data type for determining whether an undirected graph is <em>bipartite</em>
 ...
 * method takes &Theta;(1) time. It uses &Theta;(<em>V</em>) extra space (not including the graph). See
 * {@link BipartiteX} for a nonrecursive version that uses breadth-first search.
 * <p>
